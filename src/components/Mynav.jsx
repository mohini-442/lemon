                ...
                <div className='max-w-[1060px]'>
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center'>
                            ...
                            <ul className={`pl-24 flex mobileView items-center duration-700 ${show ? "right-[-100%]" : "right-0"
                                }`}>
                                <li><a href="" className=' font-poppins text-[#000] text-[15px] font-semibold relative after:absolute after:w-0 after:h-[2px] hover:after:absolute after:bottom-[-3px] hover:after:w-[72px] after:left-[50%] transition-all duration-500 after:hover:left-[10px] after:transition-all after:duration-500 hover:after:bg-[#B00000]' onClick={nav}>Our Services</a></li>
                            </ul>
                        </div>
                        <ul
                        ...
                        <div className='flex items-center gap-6'>
                            <p className=' font-poppins text-[#000] text-[15px] font-semibold cursor-pointer'>Account</p>
                            ...
                            <div className='flex items-center gap-2 cursor-pointer'>
                                ...
                                <p className='font-poppins text-[#000] text-[16px] font-semibold mb-0'><a href="tel:+2349067322844">+2349067322844</a>
