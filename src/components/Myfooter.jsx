...
const Myfooter = () => {
    return (
        <div className="bg-[#B00000] pb-20 pt-16 mt-22">
            <div className="max-w-[1220px] px-3 mx-auto" data-aos="fade-up"
                ...
                <div className="flex flex-row flex-wrap -mx-3 pb-[96px]">
                    ...
                    <div className="lg:w-8/12 px-3 pt-10 w-full" data-aos="fade-up"
                        data-aos-anchor-placement="top-bottom">
                        <div className="flex flex-row flex-wrap -mx-3">
                            <div className="md:w-3/12 w-1/2 px-3" data-aos="fade-up"
                                data-aos-anchor-placement="top-bottom">
                                <ul>
                            ...
                            <div className="md:w-3/12 w-1/2  px-3 pt-8 md:pt-0" data-aos="fade-up"
                                data-aos-anchor-placement="top-bottom">
                                <ul>
                                    <li className="font-inter font-bold leading-[150%] text-base text-white pb-6">
                                        Company
