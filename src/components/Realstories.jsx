            ...
            <div className='max-w-[960px] mx-auto px-3 pt-28'>
                <div className='flex flex-wrap flex-row -mx-3'>
                    <div className='lg:w-1/2 w-full px-3 flex flex-col lg:items-end items-center' data-aos="zoom-in-right">
                        ...
                        <div className='rounded-[8px] shadow-[0px_10px_20px_0px_#29292A12] p-[7px_32px_96px_64px] w-full lg:max-w-[350px] mt-8 relative hover:scale-[1.01] duration-[.5s]' data-aos="zoom-in-right">
                    ...
                    <div className='lg:w-1/2 w-full px-3 pt-8 flex items-center lg:items-start flex-col' data-aos="zoom-in-left">
