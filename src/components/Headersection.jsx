                ...
                <div className='flex flex-wrap flex-row -mx-3'>
                    <div className='lg:w-1/2 w-full px-3'>
                        ...
                        {activeTab === 'tab1' && <p className='fw-bold'>
                            ...
                            <p className=' font-inter text-[#808080] text-[16px] font-normal lg:max-w-[408px] sm:pt-10 text-center lg:text-start'>Blazing fast web hosting for individuals and businesses of all sizes backed by 24x7x365 Support.</p>
