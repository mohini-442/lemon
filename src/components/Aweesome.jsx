    ...
    return (
        <>
            <div className='max-w-[1272px] mx-auto px-3 rounded-[16px] bg-[#F7FAFE] pt-10 pb-20 mb-24 mt-18 relative' data-aos="fade-up"
                ...
                <div>
                    <h2 className='font-poppins md:text-[64px] text-[45px] font-semibold text-[#2E2E2E] text-center max-w-[1042px] mx-auto py-10 leading-[62px] lg:leading-[88px]' data-aos="fade-up"
                        data-aos-anchor-placement="top-bottom">We're here to make your website awesome.</h2>
                </div>
                <ul className='flex !items-center gap-2 mx-auto bg-[#B00000] p-[12px_16px_12px_16px] max-w-[200px] rounded-[8px]' data-aos="fade-up"
                    data-aos-anchor-placement="top-bottom">
                    ...
                    <li><a href="" className='text-white text-[14px] font-normal'>Get  in touch with us</a></li>
                </ul>
                <img src={t1} alt="t1" className='absolute bottom-[8%] xl:right-[-2%] right-0'/>
                <img src={t2} alt="t2" className='absolute top-[0%] left-[36%]'/>
                <img src={t3} alt="t1" className='absolute bottom-[21%] xl:left-[-1%] left-0'/>
            </div>
        </>
    )
}
